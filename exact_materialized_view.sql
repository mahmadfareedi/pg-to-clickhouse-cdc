...
SELECT 
    ...
    -- Arrays
    JSONExtract(_raw, 'after.int_array_col', 'Array(Nullable(Int32))') as int_array_col,
    JSONExtract(_raw, 'after.text_array_col', 'Array(Nullable(String))') as text_array_col,
    JSONExtract(_raw, 'after.uuid_array_col', 'Array(Nullable(String))') as uuid_array_col,
    ...
    -- Key/value (hstore as Map)
    CAST(JSONExtract(_raw, 'after.hstore_col', 'Map(String, String)'), 'Map(String, String)') as hstore_col,
    ...
    JSONExtract(_raw, 'after.int_array_col2', 'Array(Nullable(Int32))') as int_array_col2,
    JSONExtract(_raw, 'after.text_array_col2', 'Array(Nullable(String))') as text_array_col2,
    ...
    JSONExtract(_raw, 'after.bigint_array_col', 'Array(Nullable(Int64))') as bigint_array_col,
    ...
    CAST(JSONExtract(_raw, 'after.hstore_col2', 'Map(String, String)'), 'Map(String, String)') as hstore_col2,
