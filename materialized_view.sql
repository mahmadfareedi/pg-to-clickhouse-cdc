...
SELECT 
    ...
    JSONExtractString(_raw, 'after', 'created_at') as created_at,
    ...
    JSONExtractString(_raw, 'after', 'numeric_col') as numeric_col,
    JSONExtractString(_raw, 'after', 'decimal_col') as decimal_col,
    ...
    JSONExtractString(_raw, 'after', 'bool_col') as bool_col,
    JSONExtractString(_raw, 'after', 'date_col') as date_col,
    JSONExtractString(_raw, 'after', 'time_col') as time_col,
    JSONExtractString(_raw, 'after', 'timetz_col') as timetz_col,
    JSONExtractString(_raw, 'after', 'timestamp_col') as timestamp_col,
    JSONExtractString(_raw, 'after', 'timestamptz_col') as timestamptz_col,
    JSONExtractString(_raw, 'after', 'interval_col') as interval_col,
    JSONExtractString(_raw, 'after', 'uuid_col') as uuid_col,
    ...
    JSONExtractString(_raw, 'after', 'inet_col') as inet_col,
    ...
    JSONExtractString(_raw, 'after', 'int_array_col') as int_array_col,
    JSONExtractString(_raw, 'after', 'text_array_col') as text_array_col,
    JSONExtractString(_raw, 'after', 'uuid_array_col') as uuid_array_col,
    ...
    JSONExtractString(_raw, 'after', 'hstore_col') as hstore_col,
    ...
    JSONExtractString(_raw, 'after', 'numeric_col2') as numeric_col2,
    ...
    JSONExtractString(_raw, 'after', 'bool_col2') as bool_col2,
    JSONExtractString(_raw, 'after', 'date_col2') as date_col2,
    JSONExtractString(_raw, 'after', 'timestamp_col2') as timestamp_col2,
    JSONExtractString(_raw, 'after', 'timestamptz_col2') as timestamptz_col2,
    JSONExtractString(_raw, 'after', 'interval_col2') as interval_col2,
    JSONExtractString(_raw, 'after', 'inet_col2') as inet_col2,
    ...
    JSONExtractString(_raw, 'after', 'int_array_col2') as int_array_col2,
    JSONExtractString(_raw, 'after', 'text_array_col2') as text_array_col2,
    ...
    JSONExtractString(_raw, 'after', 'bigint_array_col') as bigint_array_col,
    ...
    JSONExtractString(_raw, 'after', 'hstore_col2') as hstore_col2,
    JSONExtractString(_raw, 'after', 'uuid_col2') as uuid_col2,
